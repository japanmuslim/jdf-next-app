...
export default function Dua() {
    return (
        ...
        >
            <section id="hero" className="min-h-screen flex flex-col justify-center items-center pt-32 pb-24">
                ...
                <div className="pt-20 text-center text-background z-10 space-y-10 w-full lg:max-w-4xl max-w-xs">
